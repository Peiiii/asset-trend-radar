...
export function ChartWallPagination({ id, page, pageSize, totalCount, currentCount, pageSizeOptions, onPageChange, onPageSizeChange }: ChartWallPaginationProps): JSX.Element {
